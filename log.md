...
- **The corpus refutes the 2015 reading independently of the operator, which is the part worth keeping.** Across the exact window the wiki placed Alexis in Florida she is in Dan's Uniontown house: "Alexis is sloshed" (Nov 30), "I just heard lex on the phone with her parents" (Nov 30), Suz offering a car "if I get Alexis out" (Nov 30), "Helping lex leave" (Dec 1), "Alexis only left yesterday" (Dec 2). She does not go to Florida until **2016-01-18** — "I know but she leaves for fla this week" — seven weeks *after* the breakup. `alexis-armel.md` had additionally invented a table row, "~mid-Nov 2015 | Dan moves her to Florida," by back-computing "2 weeks" from the message timestamp; no source ever asserted it.
