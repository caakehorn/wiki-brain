...
## [2026-07-18] ingest | mind+places+health | "Breaking the anxiety avoidance cycle" mined (mid-May 2026 session; ~75-point pass) + BFS PR#48 review fixes
- Review fixes (PR #48, merged): "worked returned"→"returned" (bfs-foods), Timmy index subject-verb "is"→"serve as"; llm/ copies regenerate automatically.
- Next story per operator directive (autonomous, 75-point target, steering clear of the Max/roleplay genre). Mined raw/self/dox-md/Breaking the anxiety avoidance cycle.md — a Claude-model session dated firmly to mid-May 2026 ("working for the first time since June 2024 for 2 weeks," inside the BFS window, during Annie's sharpest pull-away). Rich primary-voice interior of the Annie collapse.
- attachment-model.md (main sink; earned-page EXTENSION, not bulldoze): new section "The mechanism in Dan's own words (mid-May 2026)" — the avoidance paradox ("the more i prevent, the more i doom"), closure-dependency stated live ("do you OWE someone notification after 10 years"; "my brain CAN'T get past anything without notice"), the sx/sp "mind melding as top life priority… unhealthy extreme," the identity-fusion motive ("i loved having her tied to my identity because she's so unjustly loved and i am so unfairly maligned"), and the receipt-collecting instinct bleeding into intimacy ("in writing so i could use against her"). Contact frequency: once/day → twice in 5 weeks.
- deviance-mapping.md: added the rarity-stacking estimate (~1 in 50,000–200,000; "in Uniontown there might be zero"), the maps-for-a-different-territory reframing of the "edge case autist weirdo" self-label, and Dan's metaphysical/simulation framing of his own lifelong dysfunction — with a doubled-uncertainty caveat.
- 337-saratoga-drive.md: the mid-May housing "coup de grace" (Suz→Greensburg 30-45min = end of the Annie proximity), the failed rent-across-from-BFS-job plan (investor sunk $200k), Dan's June-9-guess vs confirmed June-23; housing fully subordinated to the bond.
- april-may-2026-final-weeks.md: contact-collapse quantified from Dan's side + cross-refs to the interior. chemical-architecture.md: Suboxone ~1-2mg/day self-report + "not leaving the bed without it" + prescribed-vs-self-managed "no comment."
- Note: Dan's loose "jan 8 2025" aura-end date NOT introduced as a datum — the Eli discovery stays Jan 9 2025 (documented). bin/wiki-lint 0 errors (307 pages); bin/wiki-connect check 0 errors; llm/ regenerated.
