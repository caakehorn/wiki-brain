---
plain_of: wiki/timeline/events/teen-concert-years
...
**The short version.** A stretch of Dan's life, roughly age twelve to thirty,
when live music was a primary mode of identity rather than a streaming
background. This is not a reconstructed favourite-artists list — it is a literal
itinerary he kept, expanded later into a researched list of thirty-six shows
spanning Ohio, Pennsylvania, New York, Maryland, New Jersey, and Florida. Three
things are true at once: he toured the scene, he didn't just like it (three Fall
Out Boy shows in eleven months plus a release-day television taping is fandom as
logistics, not a playlist); the TRL taping was an industry gimmick he was
physically inside of; and the secret show — Buffalo, November 2007, billed
"Schrute Farms" — was a deliberate in-joke he was let in on. This is the same
collector's-completeness instinct that shows up later in the forensic
message-archive work and the wiki itself: a teenager who logs every show he
attends and remembers the fake name on the marquee is already running the
archival reflex the rest of the record documents.

## The self-kept record

A Facebook "Concerts I've gone to" note, preserved verbatim across multiple
archives, records the shows Dan routed himself to during the mid-2000s emo and
pop-punk boom:
...
The 2007 Facebook status layer corroborates the intensity of that year: posts
read "swooning over the new FOB," "in New York City to see Fall Out Boy at
TRL," and a Say Anything obsession — the same window the profile names as the
imprinting period for a particular romantic-collapse fantasy. The same status
layer names "slaying on halo" and Super Mario Galaxy in the same breath — the
concert devotion and gaming were coordinates of one identity cluster, not
separate hobbies.

## The researched record

A later reconstruction expanded the itinerary against venue routing, tour
histories and support-act billing, producing a list four times the size of the
Facebook note and extending it in both directions — back to **August 2001**,
when Dan was twelve, and forward to **April 2019**. Thirty-six shows across
eighteen years.
...
**The window is not 2005–2008.** It runs from age twelve to age thirty, and the
first two entries are Rolling Rock Town Fairs in 2001 and 2002 — regional
nu-metal festivals at the Westmoreland Fairgrounds, four years before the
emo/pop-punk itinerary the Facebook note captures. The page's original framing
treated the mid-2000s scene as the origin. It was the second chapter.

**Six rows are unresolved and stay that way.** Gym Class Heroes at California
University of PA, a Taking Back Sunday campus show, The Early November, Jack's
Mannequin, Hey Monday, and the three-way John Mayer ambiguity are recorded as
open rather than guessed at. The Mayer row is the useful one: three dates are
individually plausible and the research notes that none of them sits on a
Coldplay bill, which is how the memory had filed it.

### A note on the two sources disagreeing

The self-kept Facebook note and the researched list disagree on two shows. The
note dates HIM to **2005-11-09 at Mr. Small's**; the researched list places the
Love Metal Tour at **2004-04-21, The Rock Club at Station Square**, with a
separate November 2004 return. The note dates Taking Back Sunday / Angels &
Airwaves to **2006-07-04 in Columbus**; the researched list gives **2006-06-27
at the Chevrolet Amphitheatre in Pittsburgh** and explicitly flags it as
"corrected from 2007." Neither source is discarded. The note is contemporaneous
...
1. **He toured the scene, he didn't just like it.** Three Fall Out Boy
   shows in eleven months plus a release-day television taping is fandom
   as logistics, not a playlist.
2. **The TRL taping was an industry gimmick he was physically inside of.**
   The Feb 6 2007 appearance was the 3-city / 3-show *Infinity On High*
   release-week stunt; he was in the studio for it.
3. **The secret show was a deliberate in-joke he was let in on.** Buffalo
   was billed "Schrute Farms" (a *The Office* reference) and, per a 2025
   cross-check he ran himself, was the first and only time *Take This To Your
   Grave* was played in full.

This is the same collector's-completeness instinct that shows up later in the
forensic message-archive work and the wiki itself: a teenager who logs every
show he attends and remembers the fake name on the marquee is already running
the archival reflex the rest of the record documents.
...
- **Six rows remain unresolved.** The researched list is stronger on dates but
  is not primary; the contemporaneous note is residue but may be incomplete.
  The two sources disagree on HIM and Taking Back Sunday / Angels & Airwaves,
  and neither is discarded.
- **The three-way John Mayer ambiguity** — 2003, 2004, or 2008 — has no
  resolving evidence, and none of the three sits on a Coldplay bill as the
  memory had filed it.
- **The Orlando period (October 2008–April 2009)** shows a cluster of smaller
  venues and comedy-venue bookings that doesn't match the earlier amphitheatre
  pattern — whether this reflects a move, a shift in format, or a change in
  economic access is not documented.
