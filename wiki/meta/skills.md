...
| `skills/agents/registry-push` | Push what you have into the skills database — triggers: told to update the skills in the wiki; told to push skills, MCP servers or tools into the wiki-brain; starting substantial work as a model that has not pushed befo… | `claude-code` | `skills/agents/registry-push.md` |
