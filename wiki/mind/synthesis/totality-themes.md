...
connections:
  ...
  - page: wiki/mind/synthesis/millennial-digital-witness
    type: contains
    claim: "The generational-advantage claim is the leftover the Irreversibility Firewall cannot deduct; the archive practice underneath it is the firewall's no-delete rule running on identity, now split rather than forced into one frame."
