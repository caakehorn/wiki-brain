...
A central mechanism of the bond was the weaponization of ambiguity. The dynamic systematically undermined Dan's perception of reality while his attachment system was in a state of acute activation. This was most visible during the Eli incident, which constituted the central moral harm of the relationship. During this period, obvious patterns in the data—such as late nights and deactivated location tracking—were met with DARVO-style (Deny, Attack, and Reverse Victim and Offender) shutdowns. 
