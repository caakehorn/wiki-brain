...
SCREWED" rework brand riffing on chopped-and-screwed convention. The
involuntary sub-bass signature (63–85%) is already present in this era —
...
Dates are Facebook share dates from the export; the SoundCloud pages
themselves are not archived in raw/.

| Date | Release | Type |
|------|---------|------|
| Aug 11, 2013 | The Talk It Out Mix | Mix |
| Aug 15, 2013 | The Fish in the Sea Mix (trap) | Mix |
| Aug 19, 2013 | Lemon Molly Melancholy | Original |
| Sep 16, 2013 | Bluntz (Original Mix) | Original |
| Oct 9, 2013 | ...ssest ...riends | Original |
| Oct 2013 | Trick or Trap: Molloween 2013 | Mix (undated share) |
| Dec 2013 | 2 Chainz – Netflix ft. Fergie (SLOPPPED N SCREWED Rework) | Rework (Twitter) |
| Dec 2013 | Baauer – Good 2 U (SLOPPP Loc'd Out Rethink) | Rework (Twitter) |
| 2013 | PPP RM-X 2013 (playlist) | Remix set |
| Mar 9, 2014 | Tuff – Your Parents Hate Trvping | Edit |
| Apr 8, 2014 | SLOPPP's Week in Trap — Episode 8 | Mix series |
| Apr 10, 2014 | Gladiator – Assembly Line (SLOPPP Snazzy Bounce Edit) | Edit |
| Apr 15, 2014 | Major Lazer – Aerosol Can (SLOPPP VIP Beatport Mix) | Remix |
| Apr 22, 2014 | Buffalo | Original |
| Apr 29, 2014 | Lazarus (Original Mix) | Original |
| May 7, 2014 | Drake x Cashmere Cat – No Lie ft. 2 Chainz (SLOPPP Bootleg) | Bootleg |
| Jul 26, 2014 | Heatwave Vol. 2 (Mixed by SLOPPP) | Mix |
| Jul 30, 2014 | Caked Up – Bang Your Head (SLOPPP Festival Trap Remix) | Remix |
| Oct 18, 2014 | Nick Licciardi's Guide to Mogul Skiing | Mix |
| Oct 25, 2014 | Zeds Dead – Collapse (SLOPPP Reflip) | Reflip |
| Dec 2, 2014 | Braindrops Are Falling on My Head | Original |
| ~Spring 2015 | Spring 2015 Demo | Demo |
| Dec 26, 2015 | Goodbye Demo | Final release |

Additional undated titles surfaced from link slugs across the corpora:
"Melting," "The Fine Line Between," "Nugz (Original Mix)," "The Interest of
Conflict Mix," "SLOPPP's Groovy Spring Trap," "Big Bob's Beepers
(Electrohouse)," "Dr. Igor ...atchet's Guide To...," "Detestable Drops: The
...
MOGZART project (2014–16, overlapping) became the primary identity.

## Significance

SLOPPP established three permanent features of the production identity: the
sub-bass floor that would persist through every later alias
([[wiki/interests/music/concepts/sub-bass-signature]]); the bootleg/flip
methodology (take the dominant cultural object, rework it — the same
posture later applied analytically to politics); and the zero-promotion
pattern — high-effort output shared to a tiny network, consistent with the
social-blind profile ([[wiki/mind/profile/enneagram-5w4]]) and named in
context-core as the career's actual bottleneck ("shipping / public
