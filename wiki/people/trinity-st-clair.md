...
Trinity St. Clair — the adult film performer of that name, per the contact card (booking email `booktrinitystclair@gmail.com` alongside a personal one) — was a paid companion Dan and Annie arranged to spend time with in spring 2019, another data point in the same March–June 2019 window as the [[wiki/timeline/events/shelbie-annie-threesome-april-2019|Shelbie threesome]] where the couple's non-monogamous arrangement was running with women rather than the more commonly documented male friends. Contact (`+18186510883`) is thin — 20 messages across two isolated clusters, March 21–25 and a single follow-up on December 24, 2019 — but confirms the encounter was booked, scheduled, rescheduled once for illness, and addressed to both Dan and "your girl" directly.
...
Whether the December 2019 booking inquiry led to a second visit is not documented — the thread ends there. No other mentions of Trinity appear elsewhere in the corpus read so far.
