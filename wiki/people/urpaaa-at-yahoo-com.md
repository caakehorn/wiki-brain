...
## Identity
Non-named or minimally identified contact from iMessage corpus at handle `urpaaa@yahoo.com`. 23 messages exchanged over 2017-09-28 to 2017-10-11. Sample interaction: "I'm teaching now". Appears in personal message contexts (not obvious spam per filter).

## Corpus Dimensions
| Metric | Value |
|--------|-------|
| Messages | 23 |
| Date range | 2017-09-28 – 2017-10-11 |
| Sent / Received (approx) | 0 / 23 |
| Sample | I'm teaching now |
