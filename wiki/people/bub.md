...
## Identity
Contact identified via Google Contacts as Bub. Previously unresolved contact from iMessage corpus at handle `+17249635394`. 86 messages exchanged over 2017-04-22 to 2020-10-07. Sample interaction: "Yes sir". Appears in personal message contexts (not obvious spam per filter).

## Corpus Dimensions
| Metric | Value |
|--------|-------|
| Messages | 86 |
| Date range | 2017-04-22 – 2020-10-07 |
