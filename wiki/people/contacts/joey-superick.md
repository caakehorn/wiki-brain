...
# Joey Superick## Identity
Contact identified via Google Contacts as Joey Superick. Previously unresolved contact from iMessage corpus at handle `+17245623673`. 23 messages exchanged over 2018-06-03 to 2018-06-29. Sample interaction: "Lemme know if you ever wanna play". Appears in personal message contexts (not obvious spam per filter).

## Corpus Dimensions
| Metric | Value |
|--------|-------|
| Messages | 23 |
| Date range | 2018-06-03 – 2018-06-29 |
| Sent / Received (approx) | 0 / 23 |
| Sample | Lemme know if you ever wanna play |
