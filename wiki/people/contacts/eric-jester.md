...
# Eric Jester## Identity
Contact identified via Google Contacts as Eric Jester. Previously unresolved contact from iMessage corpus at handle `+14137703708`. 103 messages exchanged over 2017-05-08 to 2025-08-15. Sample interaction: "Doubt it. I'll have to go through my mac and see.". Appears in personal message contexts (not obvious spam per filter).

## Corpus Dimensions
| Metric | Value |
|--------|-------|
| Messages | 103 |
| Date range | 2017-05-08 – 2025-08-15 |
| Sent / Received (approx) | 0 / 103 |
| Sample | Doubt it. I'll have to go through my mac and see. |
