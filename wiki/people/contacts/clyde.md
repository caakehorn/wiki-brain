...
# clyde## Identity
Contact identified via Google Contacts as clyde. Previously unresolved contact from iMessage corpus at handle `+16469534978`. 125 messages exchanged over 2019-03-27 to 2020-01-12. Sample interaction: "Still good". Appears in personal message contexts (not obvious spam per filter).

## Corpus Dimensions
| Metric | Value |
|--------|-------|
| Messages | 125 |
| Date range | 2019-03-27 – 2020-01-12 |
| Sent / Received (approx) | 0 / 125 |
| Sample | Still good |
