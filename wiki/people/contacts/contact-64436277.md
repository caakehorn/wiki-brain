...
## Identity
Non-named or minimally identified contact from iMessage corpus at handle `+16464436277`. 22 messages exchanged over 2019-09-25 to 2019-09-27. Sample interaction: "Hello. Photos are stock photos. This is me". Appears in personal message contexts (not obvious spam per filter).

## Corpus Dimensions
| Metric | Value |
|--------|-------|
| Messages | 22 |
| Date range | 2019-09-25 – 2019-09-27 |
| Sent / Received (approx) | 0 / 22 |
| Sample | Hello. Photos are stock photos. This is me |
