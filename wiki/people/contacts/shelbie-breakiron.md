...
# Shelbie Breakiron## Identity
Contact identified via Google Contacts as Shelbie Breakiron. Previously unresolved contact from iMessage corpus at handle `+17249124338`. 306 messages exchanged over 2019-05-15 to 2019-07-16. Sample interaction: "Babyboy". Appears in personal message contexts (not obvious spam per filter).

## Corpus Dimensions
| Metric | Value |
|--------|-------|
| Messages | 306 |
| Date range | 2019-05-15 – 2019-07-16 |
| Sent / Received (approx) | 0 / 306 |
| Sample | Babyboy |
