...
# Vicki## Identity
Contact identified via Google Contacts as Vicki. Previously unresolved contact from iMessage corpus at handle `+17248808079`. 234 messages exchanged over 2015-12-14 to 2018-04-05. Sample interaction: "Ok, I just didn't want to get her in any kind of trouble with social services , omg, are you serious". Appears in personal message contexts (not obvious spam per filter).
