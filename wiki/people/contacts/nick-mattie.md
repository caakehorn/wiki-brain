...
# Nick Mattie## Identity
Contact identified via Google Contacts as Nick Mattie. Previously unresolved contact from iMessage corpus at handle `+17242526986`. 170 messages exchanged over 2017-04-20 to 2017-07-12. Sample interaction: "What's up dude". Appears in personal message contexts (not obvious spam per filter).
...
| Sent / Received (approx) | 0 / 170 |
| Sample | What's up dude |
