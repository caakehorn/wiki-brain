...
## Identity
Contact identified via Google Contacts as annoying. Previously unresolved contact from iMessage corpus at handle `+13057095740`. 87 messages exchanged over 2019-06-02 to 2019-07-17. Sample interaction: "Hey bro". Appears in personal message contexts (not obvious spam per filter).

## Corpus Dimensions
| Metric | Value |
|--------|-------|
| Messages | 87 |
| Date range | 2019-06-02 – 2019-07-17 |
| Sent / Received (approx) | 0 / 87 |
| Sample | Hey bro |
