...
* **RESUME POINT:**
  1. **Continue the read at `bin/annie-corpus read 2016-01-01`** — 2015-12-31 is read (13,635 messages, 13.9%, ~160 events). January 2016 is the first full month; Annie starts Nguyen's Jan 1 and the holiday flood ends. Every pass still updates **both** pages in the same window.
  ...
  4. **Two open leads from the window are worth chasing:** who is **"j"** (the needle/ice incident, Dec 29, *"one of the last times I was over at j's"*), and who is **Lukyan** (Dec 30, drops off *"greens"* for the *"stay away from coca"* plan). Neither is in any contact list.
