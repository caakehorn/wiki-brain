...
* **Handoff Note:** Priorities for the next model, in order: (1) execute LONG_TAIL_TRIAGE.md MINE list (sam 374 / davey-fitzpatrick 382 / vaughn 228 / nick-mattie 170 + jason-bermejo opener); (2) storytime candidates per INGEST_RUNBOOK §11; (3) related:→connections retrofit + connection-queue top-down; (4) pre-2015 MASTER_DUMP_PART_1_ARCHAIC synthesis (biggest timeline hole — needs care, one cluster per pass); (5) inbox items (3 pending since 07-11/12). llm/ regenerated this session — keep regenerating after every content pass.
