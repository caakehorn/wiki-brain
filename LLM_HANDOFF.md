...
**What is on the branch.** Hub `wiki/self/twitter.md`. Yearly pages 2009–2026. Raw `raw/self/twitter/archive.jsonl` + `tweet-archive.xlsx`. **2338 originals currently filed.** Live scrape still walking 2009–2012, pre-2013-08-17, and 2026 gaps. Oldest live IDs to walk: 2009 `5083320493` (2009-10-22), 2010 `7998900357` (2010-01-20), 2011 `21615185156382721` (2011-01-02), 2012 `153328674333138944` (2012-01-01), 2013 `291049725283676160` (2013-01-15). 2026 Apr 8–May 29 and July still empty in search.
