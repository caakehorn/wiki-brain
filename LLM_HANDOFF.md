...
**What is on the branch.** Hub `wiki/self/twitter.md`. Yearly pages 2009–2026. Raw `raw/self/twitter/archive.jsonl` + `tweet-archive.xlsx`. **1985 originals currently filed.** Live scrape still walking 2009–2012, pre-2013-08-17, and 2026 gaps.
